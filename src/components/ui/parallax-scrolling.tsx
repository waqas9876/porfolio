      ...
      <section className="parallax__content">
        <div className="parallax__content-inner">
          ...
          <div className="hero-btns">
            <a href="https://wa.me/923279700070" target="_blank" rel="noreferrer" className="btn btn-primary">
          ...
          <div className="hero-socials">
            <a href="https://github.com/waqas9876" target="_blank" rel="noreferrer" className="social-icon" title="GitHub">
            ...
            <a href="https://www.linkedin.com/in/muhammad-waqas-javed-31a645283/" target="_blank" rel="noreferrer" className="social-icon" title="LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
